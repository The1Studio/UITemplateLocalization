...
namespace TheOne.Tool.Localization
{
    ...
    public class TMPLocalization : OdinEditorWindow
    {
        ...
        [ValueDropdown("GetStringTableNames")] public string StringTableName = "StringLocalizationAssets";
        ...
        [HorizontalGroup("Action Group")] [Button("Search TMP in Addressable")] [GUIColor(0.3f, 0.8f, 0.3f)] private void SearchTMPInAddressable()
        {
        ...
        [HorizontalGroup("Action Group")] [Button("AutoLocalized")] [GUIColor(1.0f, 0.5f, 0.0f)] private void DoAutoLocalized()
        {
        ...
        [HorizontalGroup("Action Group")] [Button("Add All Entry Keys")] [GUIColor(0.0f, 0.7f, 1.0f)] private void AddAllStaticEntryKeys()
        {
        ...
        [ShowInInspector, TabGroup("NoLocalized"), TableList] private List<TMPTextInfo> noLocalizedTextInfos = new();

        [ShowInInspector, TabGroup("StaticLocalized"), TableList] private List<TMPTextInfo> staticLocalizedTextInfos = new();

        [ShowInInspector, TabGroup("DynamicLocalized"), TableList] private List<TMPTextInfo> dynamicLocalizedTextInfos = new();
    }

    [Serializable] public class TMPTextInfo
    {
        [ShowInInspector, ReadOnly] private TMP_Text   tmpText;
        [ShowInInspector, ReadOnly] private GameObject prefab;

        [ShowIf("IsDynamicLocalized")] [ShowInInspector, ReadOnly] public MonoBehaviour refMono;
        [ShowIf("IsDynamicLocalized")] [ShowInInspector, ReadOnly] public string        fieldName;
        ...
        [Button("$GetLocalizationButtonName")] [GUIColor(0.3f, 0.8f, 0.3f)] [ButtonGroup("Action")] public void Localized()
        {
            ...
            this.UpdatePrefab((tmpTextInInstance) =>
                {
                    ...
                    {
                        var autoLocalization = tmpTextInInstance.AddComponent<UITemplateAutoLocalization>();
                        autoLocalization.SetUpStringEvent(TMPLocalization.Instance.StringTableName);
                    }
                },
        ...
        [ShowIf("IsDynamicLocalized")] [Button(ButtonSizes.Large)] [GUIColor(1.0f, 0.5f, 0.0f)] [ButtonGroup("Action")] public void MakeThisStatic()
        {
        ...
        [ShowIf("IsStaticLocalized")] [Button(ButtonSizes.Large)] [GUIColor(1.0f, 0.5f, 0.0f)] [ButtonGroup("Action")] public void MakeThisDynamic()
        {
            this.UpdatePrefab(_ => { }, TMPLocalization.Instance.DynamicLocalizedTextInfos);
        }
        ...
        {
            if (t.parent == null) return ""; // Or return t.name if you want just the name of the root
